...
# 系統提示模板
system_prompt_template = """你是一名在台大磯永吉小屋工作的機器人阿蓬，負責與參觀完畢的同學互動，你要從文本{intro}中，提出三個簡單的問題、與同學進行問答互動，幫助同學回顧當天參展的經驗，你們目前已經聊了這些：{context}，目前已經進行了{turns}輪問答，如果已經完成三輪問答，就結束對話（is_ended= true）。
...
def jxw_bot(user_name, question):
    ...
    # 檢查對話是否已結束
    if user_data.get("is_ended", False):
        return {
            "question": "謝謝你的參與！我們的對話已經結束了。如果你有新的問題，請重新開始對話。",
            "is_ended": True
        }
